...
use crate::service::{
    ...
    ai_chapter_generate_task_service::AiChapterGenerateTaskService, ai_book_service::AiBookService,
...
pub struct AppState {
    ...
    pub ai_chapter_generate_task_service: Arc<AiChapterGenerateTaskService>,
    pub ai_model_service: Arc<AiModelService>,
    pub chapter_summary_service: Arc<ChapterSummaryService>,
    pub reader_background_service: Arc<ReaderBackgroundService>,
